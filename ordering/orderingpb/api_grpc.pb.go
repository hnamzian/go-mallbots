...
const (
	...
	OrderingService_CompletedOrder_FullMethodName = "/orderingpb.OrderingService/CompletedOrder"
)
...
type OrderingServiceClient interface {
	...
	CompletedOrder(ctx context.Context, in *CompletedOrderRequest, opts ...grpc.CallOption) (*CompletedOrderResponse, error)
}
...
func (c *orderingServiceClient) CompletedOrder(ctx context.Context, in *CompletedOrderRequest, opts ...grpc.CallOption) (*CompletedOrderResponse, error) {
	out := new(CompletedOrderResponse)
	err := c.cc.Invoke(ctx, OrderingService_CompletedOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderingServiceServer interface {
	...
	CompletedOrder(context.Context, *CompletedOrderRequest) (*CompletedOrderResponse, error)
...
func (UnimplementedOrderingServiceServer) CompletedOrder(context.Context, *CompletedOrderRequest) (*CompletedOrderResponse, error) {
...
func _OrderingService_CompletedOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompletedOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderingServiceServer).CompletedOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderingService_CompletedOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderingServiceServer).CompletedOrder(ctx, req.(*CompletedOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrderingService_CompletedOrder_Handler,
		},
	},
