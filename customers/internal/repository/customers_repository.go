...
func (r *CustomersRepository) Save(ctx context.Context, customer *Customer) error {
...
func (r *CustomersRepository) Get(ctx context.Context, customerID string) (*Customer, error) {
...
func (r *CustomersRepository) Update(ctx context.Context, customer *Customer) error {
