...
func (x *CompletedOrderRequest) Reset() {
	*x = CompletedOrderRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CompletedOrderRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompletedOrderRequest) ProtoMessage() {}

func (x *CompletedOrderRequest) ProtoReflect() protoreflect.Message {
	mi := &file_orderingpb_api_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompletedOrderRequest.ProtoReflect.Descriptor instead.
func (*CompletedOrderRequest) Descriptor() ([]byte, []int) {
	return file_orderingpb_api_proto_rawDescGZIP(), []int{8}
}

func (x *CompletedOrderRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CompletedOrderRequest) GetInvoiceId() string {
	if x != nil {
		return x.InvoiceId
	}
	return ""
...
func (x *CompletedOrderResponse) Reset() {
	*x = CompletedOrderResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CompletedOrderResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompletedOrderResponse) ProtoMessage() {}

func (x *CompletedOrderResponse) ProtoReflect() protoreflect.Message {
	mi := &file_orderingpb_api_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompletedOrderResponse.ProtoReflect.Descriptor instead.
func (*CompletedOrderResponse) Descriptor() ([]byte, []int) {
...
var file_orderingpb_api_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x46, 0x0a, 0x15, 0x43, 0x6f,
	0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	...
	0x49, 0x64, 0x22, 0x18, 0x0a, 0x16, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x9e, 0x03, 0x0a,
	...
	0x1e, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x70, 0x62, 0x2e, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1f, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x70, 0x62, 0x2e, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x45, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1b, 0x2e, 0x6f,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4e, 0x0a, 0x0b, 0x43, 0x61, 0x6e, 0x63, 0x65,
	0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1e, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x69, 0x6e,
	0x67, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x69, 0x6e,
	0x67, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4b, 0x0a, 0x0a, 0x52, 0x65, 0x61, 0x64, 0x79,
	...
	,
...
var file_orderingpb_api_proto_goTypes = []interface{}{
	...
	(*CompletedOrderRequest)(nil),  // 8: orderingpb.CompletedOrderRequest
	(*CompletedOrderResponse)(nil), // 9: orderingpb.CompletedOrderResponse
...
var file_orderingpb_api_proto_depIdxs = []int32{
	...
	8,  // 6: orderingpb.OrderingService.CompletedOrder:input_type -> orderingpb.CompletedOrderRequest
	...
	9,  // 11: orderingpb.OrderingService.CompletedOrder:output_type -> orderingpb.CompletedOrderResponse
...
func file_orderingpb_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_orderingpb_api_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CompletedOrderRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_orderingpb_api_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CompletedOrderResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
